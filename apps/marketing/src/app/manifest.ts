// FILE: manifest.ts
// Purpose: Generates the web app manifest with CORTEX Cloud identity, icons, and screenshots.
    ...
    screenshots: [
      {
        ...
        type: "image/png",
        form_factor: "wide",
        label: "CORTEX Cloud workspace in light mode",
      },
      {
        ...
        type: "image/png",
        form_factor: "wide",
        label: "CORTEX Cloud workspace in dark mode",
      },
    ],
  };
}
