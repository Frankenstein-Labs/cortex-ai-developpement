...
export const GITHUB_REPO_URL = "https://github.com/Frankenstein-Labs/cortex-ai-developpement";
...
export const SITE_IMAGES = {
  icon: "/cortex-cloud-icon.png",
  og: "/og.png",
  lightScreenshot: "/cortex-cloud-ui-light.png",
  darkScreenshot: "/cortex-cloud-ui-dark.png",
};
...
export function changelogCollectionJsonLd(entries: readonly ChangelogEntry[]) {
  return {
    ...
    name: "CORTEX Cloud changelog",
    url: absoluteUrl("/changelog"),
    description:
      "Release notes for CORTEX Cloud, including provider support, coding-agent workflows, reliability, performance, and installer updates.",
    isPartOf: { "@id": `${SITE_URL}/#website` },
    about: { "@id": `${SITE_URL}/#app` },
    mainEntity: {
      "@type": "ItemList",
      itemListElement: entries.map((entry, index) => ({
        "@type": "ListItem",
        position: index + 1,
        name: `CORTEX Cloud ${entry.version}`,
...
export function releaseJsonLd(entry: ChangelogEntry) {
  ...
  return {
    ...
    headline: `CORTEX Cloud ${entry.version} release notes`,
    name: `CORTEX Cloud ${entry.version} changelog`,
    url: absoluteUrl(`/changelog/v${entry.version}`),
    description: `What's new in CORTEX Cloud ${entry.version}: ${highlights}.`,
...
export function sponsorJsonLd(
  ...
  return {
    ...
    name: "Support CORTEX Cloud",
    url: absoluteUrl("/sponsor"),
    description:
      "Support CORTEX Cloud through GitHub Sponsors. Monthly tiers from $5 to $499 plus custom one-time amounts fund development, releases, and documentation.",
    isPartOf: { "@id": `${SITE_URL}/#website` },
    about: { "@id": `${SITE_URL}/#app` },
    primaryImageOfPage: absoluteUrl(SITE_IMAGES.og),
    mainEntity: {
      "@type": "OfferCatalog",
      name: "CORTEX Cloud supportership tiers",
...
export function sponsorsPageJsonLd(sponsors: ReadonlyArray<{ name: string; url: string }>) {
  return {
    ...
    name: "CORTEX Cloud supporters",
    url: absoluteUrl("/sponsors"),
    description:
      "The people and companies funding CORTEX Cloud and its developer-first agentic development experience.",
    isPartOf: { "@id": `${SITE_URL}/#website` },
    about: { "@id": `${SITE_URL}/#app` },
    primaryImageOfPage: absoluteUrl(SITE_IMAGES.og),
    mainEntity: {
