...
normalizes the result, rejects backslashes and traversal, and scopes lookup/write/delete by both
workspace and organization. File saves use a version to reject stale writers instead of silently
overwriting content.
